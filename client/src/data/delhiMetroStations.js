...
// Major stations from all metro lines for testing
...
export const getStationsByLine = (lineName) => {
  return DELHI_METRO_STATIONS.filter(station => station.line === lineName);
};

// Get all unique lines
export const getMetroLines = () => {
  return [...new Set(DELHI_METRO_STATIONS.map(station => station.line))];
};
